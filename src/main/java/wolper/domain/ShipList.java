...
public class ShipList {
    ...
    public static class SmallSip {
        ...
        @Getter
        private final Set<Checks> checkSet;
        private final AtomicInteger killedPart= new AtomicInteger(0);
        public boolean contains(int i, int j) {return checkSet.contains(converter(i,j));}
        public boolean checkIfKilled() {return killedPart.incrementAndGet() == size; }
    }

    public enum Checks { A1, A2, A3, A4, A5, A6, A7, A8, A9, A10,
